...
//import { FaShoppingCart } from "react-icons/gi"
  ...
  return (
    <div className="w-full mx-auto absolute z-50">
      <div className="px-4 h-[94px] max-w-[1640px] mx-auto flex items-center justify-between z-10">
        ...
        <div className='pr-10 h-[30px] w-[300px] text-white flex justify-center items-center'> 
                <input type="text" />
                <div className='pl-1px h-[30px] w-[300px] text-white flex justify-center items-center'> 
        ...
        >
          ...
          <div className="p-7 flex justify-center items-center">
          <div className='pr-10 h-[30px] w-[300px] flex justify-center items-center'> 
                <input type="text" />
                <button>Search</button>
                </div>
            {isAuthenticated ? (
