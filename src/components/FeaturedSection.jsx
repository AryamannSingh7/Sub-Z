...
const FeaturedSection = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((prices) => {setPrices(prices.data); console.log(prices)})
  ...
  return (
    <div className="custombg relative z-20">
      ...
      <div className="w-full h-full flex flex-col justify-center items-center md:flex-row">
        {/* <Card
          name="onions"
          img='[url("https://res.cloudinary.com/ddh5a1s8j/image/upload/v1691783766/carrots_mwo0st.jpg")]'
          price="₹80/kg"
        />
        <Card
          name="tomatoes"
          img='[url("https://cdn.pixabay.com/photo/2016/03/26/16/44/tomatoes-1280859_1280.jpg")]'
          price="₹120/kg"
        />
        <Card
          name="carrots"
          img='[url("https://cdn.pixabay.com/photo/2016/11/23/00/22/carrots-1851424_1280.jpg")]'
          price="₹60/kg"
        /> */}
        <PriceCard name={prices[0].name} state={} img={prices[0].img}/>
      </div>
